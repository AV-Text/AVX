...
It's been a quarter century since the first release of AV-Bible for Windows. In its day, it was the world's first <u>free</u> bible software with a graphical user interface that ran on Microsoft Windows. Originally released as: AV-1995, AV-1996, AV-1997, ... , AV-2011.  A companion software development kit (SDK) emerged along side AV-2011. The SDK was renamed "Digital-AV" not long after its initial debut. I developed a few of freeware products on top of it, over the years. None were ever as significant as AV-Bible. The AV-Bible application name was resurrected in 2021 as a WPF application using the Z-Series edition of the Digital-AV SDK. It is, has been, and always will be: free. 
...
AVX-Framework represents a radical step forward, at the same time as it reaches back to its roots. It began in the nineties as a fast & lean KJV search tool for Windows.  The modern framework, forked from Digital-AV, is still fast & lean. They say, "The more things change, the more things stay the same." This cliche applies here. In its first incarnation, AV-Bible GUI was walled off from an in-memory database in a C++ library named "AV-Engine". AV-Engine is back! While AV-Engine itself is now C#, the remaining framework is once again C++ (because it is lean and fast). As before, AV-Engine walls-off the AV-Bible GUI, hearkening back to its roots. The return to C++ is the most substantial refactoring that has occurred in the AV/AVX family, for well over a decade. The magnitude of that effort was what led to the forking of the Digital-AV repo.  
