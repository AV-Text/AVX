...
It's been a quarter century since the first release of AV-Bible for Windows. In its day, it was the world's first <u>free</u> bible software with a graphical user interface that ran on Microsoft Windows. Originally released as: AV-1995, AV-1996, AV-1997, ... , AV-2011.  A companion software development kit (SDK) emerged along side AV-2011. The SDK was renamed "Digital-AV" not long after its initial debut. Over the years, I developed a few of freeware products on top of it. None were ever as significant as AV-Bible. The AV-Bible application name was resurrected in 2021 as a WPF application using the Z-Series edition of the Digital-AV SDK. It is, has been, and always will be: free. 
